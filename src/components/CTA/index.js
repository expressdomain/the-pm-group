        ...
        <Box bgColor={`#16171d`} maxWidth="100%" position="relative" py={5}>
            <Container display="grid" maxW={`1300px`}>
                ...
                my={10}>
                    ...
                    <Link to="/">Digital Marketing<span style={{ color: `#FDBC31` }}>{" "}|{" "}</span></Link>
                    <Link to="/">Creative &amp; Video Production<span style={{ color: `#FDBC31` }}>{" "}|{" "}</span></Link>
                    <Link to="/">Public Relations<span style={{ color: `#FDBC31` }}>{" "}|{" "}</span></Link>
