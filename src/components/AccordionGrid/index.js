            ...
            <Accordion allowMultiple>
                <AccordionItem style={{ borderColor: `transparent` }}>
                    <AccordionButton>
                        ...
                        <Box>
                        <Text my={5} style={{ textTransform: `uppercase`, fontFamily: `Montserrat`, color: `#black`, fontSize: `25px`, lineHeight: `30px` }}>{item.mbTitle}</Text>
                        </Box>
                        <AccordionIcon />
                        </VStack>
                    </AccordionButton>
                    <AccordionPanel className="accordionPanelContent" style={{ borderColor: `transparent` }} dangerouslySetInnerHTML={{ __html: item.mbContent }} pb={5} />
                </AccordionItem>
            </Accordion>
            ))}
            </Grid>
